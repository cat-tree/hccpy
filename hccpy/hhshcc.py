...
import hccpy._I0V05ED2 as I0V05ED2  # age/sex edits # V05 version
import hccpy._I0V07ED3 as I0V07ED3  # age/sex edits # V07 version
import hccpy._V0519F3M as V0519F3M  # interactions # V05 version
import hccpy._CY24M07A as CY24M07A  # interactions # V07 2024 version
import hccpy._V0519F3P as V0519F3P  # risk coef
...
class HHSHCCEngine:
    ...
    def __init__(self, myear="2022"):
        ...
        fnmaps = {
            ...
            "2024": {
                "dx2cc": "data/CY24F07A_FY2024_ICD10.TXT",
                "ndc2rxc": "data/CY24F07A_NDC24_1_24_04.TXT",
                "hcpcs2rxc": "data/CY24F07A_HCPCS24_1_24_04.TXT",
                "coefn": "data/HHS24hcccoefn.csv",
                "label": "data/V07141L2.TXT",  # Some labels changed for 2024
                "hier": "data/V07141H1.TXT"  # Same as 2022
            }
        }
        self.myear = myear
    ...
    def _apply_interactions(self, cc_lst, agegroup, age):
        ...
        if self.myear == "2024":
            cc_lst = CY24M07A.create_interactions(cc_lst, agegroup, age)
        else:
    ...
    def profile(self, dx_lst, pr_lst=[], rx_lst=[],
        ...
        agesexvar, agegroup = AGESEXV6.get_agesex(age, sex) # AVESEXV6 is unchanged across models
        ...
        if self.myear == "2024":
            cc_dct = I0V07ED3.apply_agesex_edits(cc_dct, age, sex)
        else:
